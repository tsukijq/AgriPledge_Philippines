...
impl AgriPledgeContract {
    ...
    pub fn create_commitment(
        ...
        // Record buyer as unset by storing a placeholder flag
        // Buyer is set on fund_commitment so any verified buyer can fill
    }
    ...
    pub fn fund_commitment(env: Env, buyer: Address) {
        ...
        // Remaining 60% stays in contract (escrow)
        let escrow_amount   = total - planting_amount;
